%% ROIs 
mask_dir = 'Files/ROIS_detrend_3m/'
mask_fls = dir([mask_dir 'R*.nii']);
mask_fls = {mask_fls.name}';

cat_names_fn = 'Files/cat_names.mat'
tlbls_fn = 'Files/tlbls.mat';
spm_fn_temp = 'fMRI_Data/S%d/Analysis3/';
%% Stack Scans 
...
save('Files/netRSA_data3.mat','netRSA_data');
%%