...
if exist(ofn)
    ...
    exp_Began = datetime;
    myTrials = get_exp3_myTrials; % get myTrials
end
%% Preference & Set-up
...
for i_ind = 1:numItemsPerBlock
    ...
    % Check for response
    t_onset = GetSecs;
    myTrials(trial_ind).time_presented = t_onset - trigger_time;
    keyName = {};
    keyPressTime = []; 
    responded = 0;
